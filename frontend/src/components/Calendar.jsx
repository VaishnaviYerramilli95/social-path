...
import { IoChevronBack, IoChevronForward, IoLogoFacebook, IoLogoInstagram, IoLogoLinkedin, IoLogoTwitter, IoAdd } from 'react-icons/io5';
...
const Calendar = ({ posts = [], onSelectDate, onSelectPost }) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-1 overflow-y-auto max-h-[70px]">
                {dayPosts.map((post) => {
                  const platConfig = PLATFORM_ICONS[post.platform.toLowerCase()] || { icon: IoInformationCircle, color: 'bg-slate-500' };
