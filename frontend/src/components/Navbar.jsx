...
import { IoMenuOutline, IoSearchOutline, IoNotificationsOutline, IoSunnyOutline, IoMoonOutline, IoPersonOutline, IoSettingsOutline, IoLogOutOutline } from 'react-icons/io5';
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-100 dark:border-dark-700/50 bg-white/80 dark:bg-dark-800/80 backdrop-blur-md px-6 select-none transition-colors duration-200">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <form onSubmit={handleSearchSubmit} className="hidden sm:flex items-center w-full max-w-xs relative">
